...
model = load_model("face_mask_model.h5")  # Ensure this model file is available
...
def predict_mask(image):
    ...
    img_resized = cv2.resize(img, (100, 100))  # Assuming model was trained with 100x100
...
interface = gr.Interface(
    ...
    description="Upload a face image to detect whether a person is wearing a mask or not."
)
